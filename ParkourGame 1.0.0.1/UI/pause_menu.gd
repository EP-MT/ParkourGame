...
@onready var sand = $GridContainer/Sandbox
@onready var level = $GridContainer/ResGame
...
func _on_back_pressed():
	visiblilty(t,t,t,t,t,f,f,t,f)

func _on_sandbox_pressed():
	visiblilty(t,t,t,t,t,f,f,f,t)
	
	set_pause(false)
	
	SceneSwitcher.changeScene("res://Scenes/Sanbox.tscn")
	Input.set_mouse_mode(Input.MOUSE_MODE_CAPTURED)
	esc_counter -= 1
	
func visiblilty(a : bool, b : bool, c : bool, d : bool, e : bool, f : bool, g : bool, h : bool, i : bool):
	lab.visible = a
	res.visible = b
	con.visible = c
	time.visible = d
