...
func _physics_process(delta):
	...
	pitch_pivot.rotation.x = clamp(pitch_pivot.rotation.x, deg_to_rad(-35), deg_to_rad(10))
...
func Slide():
	if Input.is_action_pressed("up") and Input.is_action_just_pressed("slide") and is_sliding == false:
		is_sliding = true
